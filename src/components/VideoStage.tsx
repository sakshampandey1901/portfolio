...
import { stageTransform, tvScreenRect } from '../lib/tvGeometry';
...
interface VideoStageProps {
  /** True while the camera is zoomed into the TV screen; disables scrubbing. */
  focused: boolean;
  photoVisible: boolean;
}

/**
 * Full-screen background stage: the scrubbed video plus the profile photo
 * masked onto the TV glass. In focus mode the whole stage receives a
 * translate+scale transform that lands the glass on the content panel.
 */
export default function VideoStage({ focused, photoVisible }: VideoStageProps) {
